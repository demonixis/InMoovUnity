...
namespace Yetibyte.Unity.SpeechRecognition.Util
{
    public static class ModelUtil
    {
        ...
        public static string GetAbsoluteModelPathByRelativePath(string modelPath) => string.IsNullOrWhiteSpace(modelPath) ? null : System.IO.Path.Combine(Application.streamingAssetsPath, modelPath);
